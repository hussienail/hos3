...
$('#d0').append(`<label title="الإذاعه" href="#" onclick="addMic();$('.pnhead').text($(this).attr('title'));setTimeout(function(){$('#mic').scrollTop(0);},100);$('.dpnl').show();"
data-toggle="tab" data-target="#mic"  class="ae fa label label-primary fa-microphone ">الاذاعه</label>`);
//$.getScript("https://raw.githack.com/hussienail/hos3/master/Hos6.js");
